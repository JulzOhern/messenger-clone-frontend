export function LikeSvg({ quickReactionSize }: { quickReactionSize: string }) {
	return (
		<svg
			aria-hidden="true"
			className="xsrhx6k transition-all duration-300"
			height={
				quickReactionSize === '' ? '20' :
					quickReactionSize === 'small' ? '25' :
						quickReactionSize === 'medium' ? '30' :
							quickReactionSize === 'large' ? '35' : '20'
			}
			viewBox="0 0 22 23"
			fill="#0e92eb"
			width={
